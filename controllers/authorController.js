...
exports.author_create_post=[
    ...
    function(req,res,next){
        ...
        if(!errors.isEmpty()){
            res.render("author_form",{title:"Author Form",errors:errors.array(),author:req.body,err:1});
        }
        else{
...
exports.author_delete_get=function(req,res,next){
    ...
    (err,results)=>{
        ...
        res.render("author_delete",{title:"Author Delete Form",author:results.author,books:results.books})
...
exports.author_update_get=function(req,res,next){
    author.findById(req.params.id).exec((err,detail)=>{
        if(err){return next(err);}
        res.render("author_form",{title:"Author Update Form",author:detail});
    });
};
...
exports.author_update_post=[
    ...
    (req,res,next)=>{
        ...
        if(!errors.isEmpty()){
            res.render("author_form",{title:"Author Update Form",author:Author,errors:errors.array(),err:1});
        }
        else{
